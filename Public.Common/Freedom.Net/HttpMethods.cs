...
namespace Public.Common
{
    public class HttpMethods
    {
        ...
        /// <returns></returns>
        public static string HttpPost(string url, string param = null, string type = null)
        {
            ...
            request.Method = "POST";
            request.ContentType = type ?? "application/x-www-form-urlencoded";
            request.Accept = "*/*";
        ...
        /// <returns></returns>
        public static  string HttpPostFile(string uriStr, string name, string fileName, byte[] data)
        {
            try
            {
